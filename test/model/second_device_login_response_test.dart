...
void assertSecondDeviceLoginResponse(SecondDeviceLoginResponse actual, SecondDeviceLoginResponse secondDeviceLoginResponse){
  ...
  expect((actual.contentAbove as Text).contentType,
      (secondDeviceLoginResponse.contentAbove as Text).contentType);
  expect((actual.contentAbove as Text).value.default_,
      (secondDeviceLoginResponse.contentAbove as Text).value.default_);
  expect((actual.contentAbove as Text).value.value,
      (secondDeviceLoginResponse.contentAbove as Text).value.value);
